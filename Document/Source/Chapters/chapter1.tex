...
\begin{itemize}
  \item Implement a pipeline that can segment moving of rigid objects by running a long term analysis of point trajectories by using optical flows and depth cues.
