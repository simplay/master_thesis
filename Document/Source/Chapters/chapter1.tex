...
% state focus of thesis: There is a plentitude of semantic information in how things move and this is why this thesis focusses on
\\ \\
...
Ideally, a motion segmentation pipeline would therefore make use of optical flows and the same time exploit measured depth maps. 
