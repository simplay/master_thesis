...
So, the remaining question is: what step-size should be used to generate the sparse set of tracking candidates? To answer this question we have run different sampling rates on our datasets and visualized the resulting tracking candidates. An example illustrating different sampling rates is dipicted in figure $\ref{fig:sampling_rate_candidates}$. \\ \\
\begin{figure}[H]
\begin{center}
