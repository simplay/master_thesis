...
\end{equation}
by using Matlab's fast eigen-decomposition $\textit{eigs}$. In figure $\ref{fig:cars_eigenvectors_laplacian}$ we visualize how some of these eigenvectors might look like.
\begin{figure}[H]
\begin{center}
