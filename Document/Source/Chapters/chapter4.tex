...
\end{center}
\caption{A visualization of the tracking candidates extraction stages. For a given input image as shown in subfigure $\ref{fig:c14_f1_cand}$ we want to compute a sparse set of traceable feature locations as shown in subfigure $\ref{fig:c14_cand_sparse}$.}
...
\end{center}
\caption{A visualization of different sampling rates of tracking candidates}
...
\end{center}
\caption{A visualization of the final dense traceable features.}
...
\end{center}
\caption{A visualization of the all invalid locations shown in white color illustrated in subfigure $\ref{fig:c14_invalid_regions}$.}
