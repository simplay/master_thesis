% TODO ask: macht SRSF PD überhaupt sinn?
\chapter{Experiments}
...
\begin{tabular}{|c|c|c|c|c|}
\hline
\multicolumn{5}{|c|}{Performance Waving Hand dataset}                        \\ \hline
Method & \textbf{Density} & \textbf{Precision} & \textbf{Recall} & \textbf{F1 Score} \\ \hline
PD SC & 0.58 & 69.67\%   & 58.66\%     & 63.69\%  \\ \hline
PED MC & 0.36 & 71.60\%   & 70.52\%     & 71.06\%  \\ \hline              
\end{tabular}
\caption[Cars Varying $\lambda$]{My caption}
