...
\end{center}
\caption[Convergence Rate MinCut Segmentation]{Visualizing the convergence rate of MinCut when running LDOF PED MC. We observe, that the more iterations are run, the higher the F1-Score gets. However}
