...
\begin{center}
\subfigure[Frame 25]{
   \includegraphics[width=0.47\linewidth] {evaluation/alley/segmentations/seg_f_25}
   \label{fix:alley_segmentations_a}
}
\subfigure[Frame 30]{
   \includegraphics[width=0.47\linewidth] {evaluation/alley/segmentations/seg_f_30}
   \label{fix:alley_segmentations_b}
}
~
\subfigure[Frame 35]{
   \includegraphics[width=0.47\linewidth] {evaluation/alley/segmentations/seg_f_35}
   \label{fix:alley_segmentations_a}
}
\subfigure[Frame 40]{
   \includegraphics[width=0.47\linewidth] {evaluation/alley/segmentations/seg_f_40}
   \label{fix:alley_segmentations_b}
}
\end{center}
\caption[Bonn Cerealbox Segmentations]{foobar}
