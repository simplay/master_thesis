function uv = estimate_flow_hs(im1, im2, varargin)
%ESTIMATE_FLOW_HS   Optical flow computation using Horn & Schunck's method
%   takes in two input images IM1 IM2 (grayscle or color) and compute the
%   flow field from IM1 to IM2. 
%
% output UV is an M*N*2 matrix. UV(:,:,1) is the horizontal flow and
% UV(:,:,2) is the vertical flow.
%
%UV = ESTIMATE_FLOW_HS(IM1, IM2, 'PARAMETER1 NAME', PARAMETER1 VALUE, 'PARAMETER2 NAME', PARAMETER2 VALUE ...);
