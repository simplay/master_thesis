...
public class DepthVarFieldTest {
    @Test
    public void testCreate() {
        int m = 3; int n = 4;
        DepthVarField var = new DepthVarField(m, n);

        Field field = null;
        try {
            field = DepthVarField.class.getDeclaredField("matrix");
    ...
    public void testValueAt() {
        ...
        for (int k = 0; k < m; k++) {
            for (int l = 0; l < n; l++) {
                assertEquals(rows.get(k)[l], var.valueAt(k, l), 0);
            }
        }
        ...
        try {
            ...
            try {
                ...
                for (int k = 0; k < N; k++) {
                    ...
                    assertEquals(sum, var.valueAt(x, y), 0);
                }
