function [ figure_dir_name ] = runMerger( DATASET, PREFIX_INPUT_FILENAME, METHODNAME, FRAME_IDX, FILTER_AMBIGUOUS,  FilePath, FileName)
%RUNMERGER Summary of this function goes here
