function [W, U_full, S_full, U_small, S_small] = extract_eigendecomp_data(BASE, DATASET, PRE, W, U_full, S_full, THRESH, USE_EIGS, COMPUTE_EIGS, USE_CLUSER_EW_COUNT, FORCE_EW_COUNT)
